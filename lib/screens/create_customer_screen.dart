...
class _CreateCustomerScreenState extends ConsumerState<CreateCustomerScreen> {
  ...
  Future<void> _save() async {
    ...
    final newCustomer = Customer(
      ...
      businessJobType: _jobType,
      businessJobName: _jobNameCtrl.text.trim().isEmpty ? null : _jobNameCtrl.text.trim(),
      dutyType: _dutyTypeCtrl.text.trim().isEmpty ? null : _dutyTypeCtrl.text.trim(),
      annualIncome: double.tryParse(_incomeCtrl.text.trim()),
